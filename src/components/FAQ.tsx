 ...
 *
 * Usage in Astro:
 *   <FAQ client:visible items={[...]} />
 *
 * For SEO, also generate an FAQ JSON-LD schema (see src/lib/jsonld.ts:faqSchema)
 * and pass it to BaseLayout's jsonLd prop. This can produce rich FAQ accordion
          ...
          {items.map((item, index) => (
            ...
            >
              <Accordion.Header asChild>
                <h3 className="m-0">
                  <Accordion.Trigger
                    className="flex items-center justify-between w-full px-6 py-4 text-left font-medium text-brand-dark hover:bg-brand-light transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-primary [&[data-state=open]>svg]:rotate-180"
                  >
