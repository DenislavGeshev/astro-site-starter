            ...
            {item.children ? (
              ...
              <>
                <NavigationMenu.Trigger
                  className="px-3 py-2 text-sm font-medium text-brand-dark hover:text-brand-primary transition-colors rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-primary"
                >
                  {item.label}
              ...
              <NavigationMenu.Link asChild>
                <a
                  href={item.href}
                  className="block px-3 py-2 text-sm font-medium text-brand-dark hover:text-brand-primary transition-colors rounded-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand-primary"
                >
                  {item.label}
                </a>
              </NavigationMenu.Link>
