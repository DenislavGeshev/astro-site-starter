 ...
 *
 * Structured data tells search engines what your content IS (not just what it says).
 * Search engines use it to show rich results: star ratings, FAQs, breadcrumbs in
 * search, etc.
 *
 * Each helper returns a properly typed object that you can render inside a
